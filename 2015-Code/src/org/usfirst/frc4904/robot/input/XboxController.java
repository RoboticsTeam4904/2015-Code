...
public class XboxController extends Joystick {
	...
	/**
	 * Experimental method to determine if the Xbox controller is connected to the driver station.
	 * 
	 * @return Whether the Xbox controller is connected
	 */
	public boolean connected() {
		// Checks if the driver station detects any buttons on the Xbox controller port
