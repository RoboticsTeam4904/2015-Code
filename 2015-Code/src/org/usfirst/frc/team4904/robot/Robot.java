...
public class Robot extends SampleRobot {
	...
	public Robot() {
		...
		mecanumDrive = new Mecanum(frontLeftWheel, frontRightWheel,
				backLeftWheel, backRightWheel); // Initialize Mecanum control
	...
	public void autonomous() {
		...
		new Updater(state, new Updatable[] { controller, align },
				slowUpdatePeriod).start(); // Controller and align are potentially slower
		new Updater(state, new Updatable[] { imu, driver, operator,
				mecanumDrive, lidar }, fastUpdatePeriod).start(); // These should have fast updates
	...
	private class Updater extends Thread { // Function to update automatically in a new thread
		...
		public Updater(RobotState state, Updatable[] toUpdate,
				double updateSpeed) {
