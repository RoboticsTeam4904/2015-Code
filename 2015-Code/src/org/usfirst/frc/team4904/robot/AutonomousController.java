...
public class AutonomousController implements Updatable {// This needs to be a separate class because it can't extend both Operator and Driver
	...
	public synchronized void update() {// This is in this architecture because this
